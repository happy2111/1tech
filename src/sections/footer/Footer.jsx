    ...
    <div id='footer'  className='h-[110vh] flex items-center lg:p-0 pb-[50px] '>
        <div className="container">
            <div className='flex lg:justify-between items-center lg:flex-row flex-col' >
                <motion.div initial="hidden" whileInView="visible"  className='lg:w-[50%]'>
                    <motion.img variants={cardAnimation} custom={1} src={footer_anim} className='md:h-[614.4px] ' alt="animation" />
                </motion.div>
                <motion.div initial="hidden" whileInView="visible" className='lg:w-[50%] flex flex-col justify-center lg:pl-[120px]'>
                    <motion.h1 variants={cardAnimation} custom={2} className='text-white  font-bold text-[45px]'>Contact Us</motion.h1>
