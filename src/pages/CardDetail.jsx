...
// ****fetching 
  ...
  if (!card) return <div className='h-lvh'> <section class="dots-container"><div class="dot"></div><div class="dot"></div><div class="dot"></div><div class="dot"></div><div class="dot"></div></section></div>;
// ****fetching 
...
// ****text 
  ...
  const TruncatedText = ({ text, maxLength }) => {
    ...
    return <p className='text-[14px] text-black'>{truncated}</p>;
  }; 
// ****text 
